            ...
            <div class="container-fluid" style="background-color:#F5F5F5;">
                <div class="row bg-title" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:black;">Driver Details: DRV-0001</h4>
                    </div>
                  ...
                  <div class="col-lg-6 col-sm-6">
                      ...
                      <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                        <h3 class="box-title m-b-0" style="color:black;">Driver Details</h3>
                                        <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains the contact information of the driver.</span>
                                        <div class="row" style="margin-top:10px; ">
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Driver</strong>
                                                    <br>
                                                    <p class="text-muted">{{$driver->name}}</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>License #</strong>
                                                    <br>
                                                    <p class="text-muted">{{$driver->license_num}}</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6 b-r"> <strong>Contact Number</strong>
                                                    <br>
                                                    <p class="text-muted">{{$driver->contact_num}}</p>
                                                </div>
                                                <div class="col-md-6 col-xs-6"> <strong>Availability</strong>
                                                    <br>
                                                    <p class="text-muted">{{$driver->availability}}</p>
                                                </div>
                                            </div>
                                    </div>
                            </div>
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                        <h3 class="box-title m-b-0" style="color:black;">Driver Update History</h3>
                                        <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains all updates on this driver.</span>
                                        <p class="text-muted m-b-30"></p>
                                    <hr>
                                        <h3 style="font-weight:700; font-size:14px; color:black; font-family:Helvetica,Arial,sans-serif;">Driver Details: DRV-0001</h3>
                            ...
                            <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                            ...
                                            <div class="white-box" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
                                                ...
                                                <span class="text-muted" style="font-size:12px; color:black; font-family:Helvetica,Arial,sans-serif;">Note: This section contains the schedule/s assigned for this driver.</span><br>
